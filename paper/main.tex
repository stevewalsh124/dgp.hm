...
We consider $\Sigma_\epsilon$ as known, given domain-matter expertise. (right)?
\textcolor{red}{(Do we actually tailor this?  I thought it was consistent across the board.)}
...
\textcolor{red}{(How do you get UQ though?)}
