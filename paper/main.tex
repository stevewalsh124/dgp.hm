...
\[
\Sigma_S(X)^{i,j} = \tau^2  \left( 1 + \frac{\sqrt{5}d}{\sqrt{\theta}} + 
  \frac{5d^2}{3\theta}\right) \exp\left(-\frac{\sqrt{5}d}{\sqrt{\theta}}\right)
\quad\textrm{for}\quad 
d=||x_i-x_j||^2
\]
Hyperparameters $\tau^2$ and $\theta$ govern the correlation scale and decay respectively.
